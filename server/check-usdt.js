...
async function checkUSDTData() {
  console.log('🔍 Checking USDT token data...\n');

  try {
    const response = await axios.get('http://localhost:8080/api/v1/coingecko/tokens/tether');
    
    console.log('✅ USDT token data:');
