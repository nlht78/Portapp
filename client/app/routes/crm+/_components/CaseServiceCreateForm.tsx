...
export default function CaseServiceCreateForm({
  customer,
  employees,
}: {
  customer?: ICustomer;
  ...
  const handleCancel = () => {
    navigate(`/crm/ca-dich-vu`);
  };

  return (
    <fetcher.Form method='POST' action='/crm/ca-dich-vu/new'>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
            ...
            <div className='bg-white h-full border border-gray-200 rounded-md p-5 shadow-sm'>
              <div className='flex items-center justify-between'>
                ...
                <CRMButton tagType='link' href='/crm/khach-hang'>
                  Thay đổi khách hàng
                </CRMButton>
              </div>
